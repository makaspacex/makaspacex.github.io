...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pokeman-parameters.png)
#### Regression的具体过程
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/model.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/goodness-of-function.png)
### Loss function 损失函数
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/loss-function.png)
### Loss function可视化
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/loss-figure.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/best-function.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/gradient-two-parameters.png)
## Gradient Descent的缺点
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/gradient-stuck.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/results.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/Xcp-2.png)
### 考虑$(x_{cp})^3$的model

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/Xcp-3.png)
### 考虑$(x_{cp})^4$的model

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/Xcp-4.png)
### 考虑$(x_{cp})^5$的model

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/Xcp-5.png)
### 5个model的对比
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/Xcp-compare.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/Xcp-overfitting.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/hidden-factors.png)
因此我们重新设计model：
$$
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/new-model.png)
有了上面这个model以后，我们分别得到了在training data和testing data上测试的结果：

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/new-results.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/regularization.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/regularization-performance.png)
#### conclusion总结
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/L1L2regularization.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/L1-L2.png)