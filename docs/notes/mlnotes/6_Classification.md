---
title: "Classification: Probabilistic Generative Model"
lang: zh-CN
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pokemon-types.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pokemon-features.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/classification-regression.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/ideal-alternatives.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/two-class.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/turtle.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/feature.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/gaussian-distribution.png)


同理，如果是同样的$u$，不同的$\Sigma$，概率分布最高点的地方是一样的，但是分布的密集程度是不一样的

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/gaussian-same-u.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/maximum-likelihood.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/gaussian.png)


同理，我们用极大似然估计法在高斯函数上的公式计算出class 2的两个参数，得到的最终结果如下：

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/maximum-2case.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/do-classification.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/classification-result.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/modify-model.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/modify-compare.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/three-steps.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/distribution.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/posterior-probability.png)


这个S函数是已知逻辑函数，现在我们来推导一下z**真正的样子**，推导过程如下：

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/z1.png)
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/z2.png)


![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/z3.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/z-final.png)
