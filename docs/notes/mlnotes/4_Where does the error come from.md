---
title: Where does the error come from?
lang: zh-CN
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/estimator.png)
#### 抽样分布
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/bias-variance.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/5000-tests.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/model-bias.png)
### 为什么会这样？
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/bias-vs-variance.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/large-bias.png)
2、**如果variance比较大**
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/large-variance.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/regularization-illustration.png)
#### Model Selection
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/model-selection.png)
## 怎样做才是可靠的呢？
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/cross-validation.png)
### 考虑真实的测试集
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/n-flod-cross-validation.png)
#### 总结conclusion
