---
title: "Unsupervised Learning: PCA(Ⅱ)"
lang: zh-CN
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/bc.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/re.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/svd.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-nn.png)

- 得到$c_1$之后，再让它乘上$w^1$，得到$\hat x$的一部分

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-nn2.png)

- 对$c_2$进行同样的操作，乘上$w^2$，贡献$\hat x$的剩余部分，此时我们已经完整计算出$\hat x$三个分量的值

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-nn3.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-weak.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-poke.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-poke2.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-poke3.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-mnist.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/pca-face.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/nmf-mnist.png)

## NMF for Face

在Face数据集上，通过NMF找到的前30个组价如下图所示，相比于PCA这里更像是脸的一部分

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/mlnotes/img/nmf-face.png)
