...
![CPU和GPU的简单架构对比图](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/cpu_gpu.png)
...
![CPU简单信息](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/cpu_specs.png)

![GPU的简单信息对比](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/gpu_specs.png)
...
![GPU的简单信息对比](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/gpu_memory_arch.png)

![GPU的内存架构容量信息](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/gpu_memory.png)
...
![CUDA简单介绍](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/cudacore.jpg)
...
![CUDA 矩阵乘法示例](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/mat_mul_gpu.png)
...
![浮点计算能力和价格的对比。](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/gtx.png)
...
![cuda8.0](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/cuda8.0.png)

![cuda9.0](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/dlwarm/img/ch15/cuda9.0.png)  
