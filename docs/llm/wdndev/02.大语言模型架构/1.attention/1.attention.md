...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_bfiZnT0f5w.png)

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_XVu-CvbRqc.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_N-MRyK7Kjn.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_J3LRkcY0rt.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_mcpY8Z5rJG.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_25Hri7grcr.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_JdHeyN9KuN.png)

下图给出了标准的注意力机制的实现流程，可以看到因为`HBM`的大小更大，**我们平时写pytorch代码的时候最常用到的就是HBM，所以对于HBM的读写操作非常频繁，而SRAM利用率反而不高**。

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_T3mOuzLLlx.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_I2wpAfCOTM.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_xdtEZOlGec.png)

为方便理解，下图将FlashAttention的计算流程可视化出来了，简单理解就是每一次只计算一个block的值，通过多轮的双for循环完成整个注意力的计算。

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_bck1Jw3P5A.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_eb5Z7pLEGk.png)
