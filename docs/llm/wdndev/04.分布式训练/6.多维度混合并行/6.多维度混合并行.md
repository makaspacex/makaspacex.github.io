...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_bUIvBaOcRU.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_k9CHrkio0V.png)

#### 1.2 3D并行（DP + PP + TP）

而为了更高效地训练，可以将 PP、TP 和 DP 相结合，被业界称为 3D 并行，如下图所示。

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_t-u4XUpBo6.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_hSdhjiBAKu.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_rDgAztG68n.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_xXH59JVt51.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_nW2idHS-Lv.png)
...
![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_YtAUDmNynT.png)

Bloom-176B 进行预训练时，在 384 张 NVIDIA A100 80GB GPU (48 个节点) 上使用了 3D 并行（数据并行、流水线并行、张量并行 ）策略，针对 350B 个Token 训练了大约 3.5 个月。

![](https://cdn.jsdelivr.net/gh/makaspacex/PictureZone@main/libs/wdndev/image/image_9MhlIzGPSn.png)
